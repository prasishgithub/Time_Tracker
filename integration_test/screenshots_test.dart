...
import 'package:timetracker/data_providers/data/mock_data_provider.dart';
import 'package:timetracker/data_providers/notifications/notifications_provider.dart';
import 'package:timetracker/data_providers/settings/mock_settings_provider.dart';
import 'package:timetracker/data_providers/settings/settings_provider.dart';
import 'package:timetracker/main.dart' as app;
import 'package:timetracker/screens/dashboard/components/RunningTimerRow.dart';
...
void main() {
  ...
  group('end-to-end test', () {
    testWidgets('tap on the floating action button, verify counter',
      ...
      ], child: app.timetrackerApp(settings: settings)));
