...
import 'package:timetracker/data_providers/l10n/l10n_provider.dart';
...
class FluentL10NProvider extends L10NProvider {
  ...
  @override
  String timetrackerDatabase(String date) =>
      _bundle.format("timetrackerDatabase",
          args: <String, dynamic>{"date": date}, errors: _errors) ??
      "timetrackerDatabase";
  @override
  String timetrackerEntries(String date) =>
      _bundle.format("timetrackerEntries",
          args: <String, dynamic>{"date": date}, errors: _errors) ??
      "timetrackerEntries";
  @override
